...
@userge.on_cmd("sudo",
               about={'header': "enable / disable sudo access"},
...
@userge.on_cmd("delsudo",
               about={'header': "delete sudo user",
...
@userge.on_cmd("addscmd",
               about={'header': "add sudo command",
...
@userge.on_cmd("delscmd",
               about={'header': "delete sudo commands",
